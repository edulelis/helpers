...
class LumenHelperServiceProvider extends ServiceProvider
{
    /**
    ...
    public function register()
    {
        ...
        //load custom helpers automatically
            ...
            foreach (glob(base_path('app') . '/' . $this->getHelpersDirectory() . '/*.php') as $file) {
                require_once($file);
            }
        }
    }
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__ . '/config/helpers.php' => base_path('config') . '/helpers.php',
        ], 'config');
    }
